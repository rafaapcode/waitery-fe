...
export const createOrgFormSchema = z.object({
  ...
  location_code: z.string("O número do estabelecimento é obrigatório").min(0, "O número do estabelecimento deve ser válido"),
  cep: z.string("O número do CEP é obrigatório").min(0, "O número do CEP deve ser válido"),
